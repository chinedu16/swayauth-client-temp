...
const Login = () => {
  ...
  const [state, formAction] = useFormState<
    Promise<ResponseProp<LoginProp | null>>,
    any
  >(handleLoginform, { status: false, message: "", data: null });
    ...
    if (state.status) {
      if (state?.data?.two_factor_enabled) {
        setTwoFactor((p) => ({
          ...
          two_factor_type: state?.data?.two_factor_type,
        }));
      }
    } else {
    ...
    <main className="flex justify-center items-center min-h-[100svh] p-2 md:p-12">
      <div className="max-w-xl w-full">
        <Link href="/" className="inline-block mb-4 mx-4">
          <div className="md:inline-flex items-center hidden">
            <Image
              src="/logo-circle.png"
              alt=""
              className="w-[2rem] h-[2rem] max-w-[2.5rem]"
              width={1232}
              height={1232}
            />
        ...
        <form
          ...
          className="p-6 md:p-10 shadow-lg border rounded-md"
        >
          ...
          <div className="mb-4">
            ...
            <div className="mt-1 flex items-center relative">
              ...
              />
              <button
                onClick={() => setVisiblePassoword(!visiblePassoword)}
                type="button"
                className={`inline-block absolute right-3 ${visiblePassoword ? "" : "opacity-40"}`}
              >
          ...
          <div className="mt-10 text-center">
            <div>
              <span className="inline-block text-slate-600 mr-2">
          ...
          <div className="mt-4 flex justify-center items-center">
            <button
              ...
              className="inline-block mr-2 active:scale-105"
            >
              <Image
                src="/google.png"
                className="max-w-[2rem] max-h-[2rem] p-[0.05rem]"
                alt=""
                width={480}
                height={480}
              />
            ...
            <button
              ...
              className="inline-block ml-2 active:scale-105 "
            >
              <Image
                src="/facebook.png"
