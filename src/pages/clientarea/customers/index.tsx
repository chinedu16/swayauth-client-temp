import { faBan, faBolt, faChevronLeft, faChevronRight, faEllipsisV, faEye, faTrash } from "@fortawesome/free-solid-svg-icons";
...
const Customer = () => {
  ...
  return <div className="py-3 md:py-6 px-4 md:px-8">
    ...
    <div className="relative shadow-md sm:rounded-lg bg-white mt-8">
      <div className="px-5 pt-6 text-left w-full">
        <div className="w-full flex justify-between flex-wrap items-end">
          <div className="flex w-full lg:w-auto flex-wrap justify-between">
            <div className="mb-6 w-6/12 md:w-3/12 lg:w-auto pr-2">
              <div className="px-4 pt-2 pb-1 border rounded-lg shadow-md">
                <h4>Total Users</h4>
                <h2 className="text-2xl font-bold mt-1">{money(320302, false)}</h2>
              </div>
            </div>
            <div className="mb-6 w-6/12 md:w-3/12 lg:w-auto pl-2 md:px-2">
              <div className="shadow-md overflow-hidden border px-4 pt-2 pb-1 rounded-lg">
                <h4>Organisations</h4>
                <h2 className="text-2xl font-bold mt-1">{money(4, false)}</h2>
              </div>
            </div>
            <div className="mb-6 w-6/12 md:w-3/12 lg:w-auto pr-2 md:px-2">
              <div className="shadow-md px-4 pt-2 pb-1 border rounded-lg">
            ...
            <div className="mb-6 w-6/12 md:w-3/12 lg:w-auto pl-2">
              <div className="shadow-md px-4 pt-2 pb-1 border rounded-lg">
          ...
          <div className="flex mb-6 w-full justify-end lg:w-auto items-center">
            <DropDown.Container>
        ...
        <table className="w-full text-left font-normal">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="row" className="px-4 pt-2 whitespace-nowrap">
                <div className="whitespace-nowrap">
                  <small className="inline-block px-3 bg-green-600 text-white rounded-md">Active</small>
                </div>
              </td>
              <td scope="row" className="px-4 pt-2 whitespace-nowrap">
                <div className="whitespace-nowrap">
              ...
              <td className="px-4 pt-2 whitespace-nowrap">
                <div className="flex whitespace-nowrap items-center">
                  ...
                  <button className="mr-2 hover:bg-slate-200 px-1 rounded-full" title='disable'>
